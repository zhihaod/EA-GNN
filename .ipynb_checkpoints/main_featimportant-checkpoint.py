...
for cfg_name in cfg_names:
    print(cfg_name)
    cfg_file = task_path + 'cfg/ncgnn/feat_importance/' + cfg_name + '.yaml'
    ...
    for ratio in compress_ratios:
        ...
        if dataset in ['cora','citeseer','pubmed','academic_cs','academic_py']:
            ...
            feat_data_compress = feature_importance_selection(features,labels,ratio)
    ...
    save_list(path_result+f'{dataset}/'+f'{model_name}_{num_sample}_{feature_select}.pkl',results)  
